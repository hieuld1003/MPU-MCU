...
int timer_blink_counter = 0; // Thêm biến counter
int timer_blink_flag = 0;    // Thêm biến flag
...
void setTimer_Blink(int duration){ // Thêm hàm
...
void timer_run(){
    ...
    if(timer_blink_counter > 0){ // Thêm logic đếm
        timer_blink_counter--;
