...
void update7SEG(int index) {
    // Tắt hết các EN để chống bóng mờ
...
void scan7SEG() {
    if (timer_7seg_scan_flag == 1) {
        setTimer_7seg_scan(250); // Quét mỗi 250ms
