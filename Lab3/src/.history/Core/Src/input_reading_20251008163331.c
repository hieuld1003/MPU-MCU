...
#define BUTTON_IS_PRESSED BTN_PRESSED  // Changed to use the new define
#define BUTTON_IS_RELEASED BTN_RELEASED  // Changed to use the new define
...
//Checking if a button is pressed more than a second or not
