...
// Button states - use custom names to avoid conflicts with HAL
enum ButtonState {BTN_STATE_RELEASED, BTN_STATE_PRESSED, BTN_STATE_PRESSED_MORE_THAN_1_SECOND};
enum ButtonState buttonState[3] = {BTN_STATE_RELEASED, BTN_STATE_RELEASED, BTN_STATE_RELEASED};
    ...
    switch(buttonState[index]) {
        case BTN_STATE_RELEASED:
            if (is_button_pressed(index)) {
                buttonState[index] = BTN_STATE_PRESSED;
        ...
        case BTN_STATE_PRESSED:
            if (!is_button_pressed(index)) {
                buttonState[index] = BTN_STATE_RELEASED;
            } else {
                if (is_button_pressed_1s(index)) {
                    buttonState[index] = BTN_STATE_PRESSED_MORE_THAN_1_SECOND;
        ...
        case BTN_STATE_PRESSED_MORE_THAN_1_SECOND:
            if (!is_button_pressed(index)) {
                buttonState[index] = BTN_STATE_RELEASED;
            } else {
